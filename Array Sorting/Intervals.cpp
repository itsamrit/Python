🟩🟩ONLY and only REMEMBER CODE OF MERGING INTERVALS .  IN merging u just need to sort 1st index not 2nd like u dont need to do this : if(arr[i][0]==arr[i+1][0])return arr[i][1]>...
